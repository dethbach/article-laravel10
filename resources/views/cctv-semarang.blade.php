...
<head>
    ...
    <title>Jual CCTV Semarang</title>
...
<body>
            ...
            <div class="container-fluid hero-content">
                <div class="row mb-3">
                    <div class="col text-center">
                        <img src="{{asset('storage/web-material/cctv-logo.png')}}" alt="Jual CCTV Semarang" class="logo" height="250">
                    </div>
                </div>
                <div class="row mb-0">
                    <div class="col text-center text-light">
                        <h1>JUAL CCTV SEMARANG</h1>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col text-center text-light">
                        <h5>Harga Termurah Dengan Kualitas Terbaik dan Profesional</h5>
                    </div>
                </div>
                <div class="row mb-5">
                    <div class="col text-center">
                        <a href="https://wa.me/6281225113000" class="btn btn-contact-us px-4 py-2" target="_blank">Hubungi Kami</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Brand Section -->
    <section id="brand" class="my-0 py-5">
        <div class="container">
            <div class="row" style="margin-top: 70px;margin-bottom: 100px">
                <div class="col text-center" data-aos="fade-up" data-aos-duration="2000">
                    <h1>OUR TOP CCTV BRAND</h1>
                </div>
            </div>
            <div class="row justify-content-center" data-aos="zoom-in" data-aos-duration="2000">
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Dahua.png')}}" alt="logo Dahua" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Hikvision.png')}}" alt="logo Hikvision" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Hi-Look.png')}}" alt="logo HiLook" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Panasonic.png')}}" alt="logo Panasonic" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Techma.png')}}" alt="logo Techma" />
                </div>
            </div>
            <div class="row justify-content-center" data-aos="zoom-in" data-aos-duration="2000">
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/spc.png')}}" alt="logo spc" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/ezviz.png')}}" alt="logo ezviz" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Xiaomi.png')}}" alt="logo Xiaomi" />
                </div>
                <div class="col-md-2 col-sm-6 col-6 mb-5 img-brand d-flex justify-content-center">
                    <img src="{{asset('storage/web-material/brand/Bardi.png')}}" alt="logo Bardi" />
                </div>
            </div>
        </div>
    </section>
