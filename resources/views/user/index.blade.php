    ...
    <style>
        ...
        .loading-cat .head .face {
            ...
            background: radial-gradient(circle, #f2c089 0%,
                ...
                radial-gradient(circle, #383c4b 0%, #383c4b 6%, transparent 6%) -12px -12px no-repeat, radial-gradient(#eda65d 0%, #eda65d 15%,
                    transparent 15%) 0 -11px no-repeat,
                radial-gradient(circle, transparent 5%,
                    #383c4b 5%, #383c4b 10%, transparent 10%) -3px -5px no-repeat,
                radial-gradient(circle, transparent 5%,
                    #383c4b 5%, #383c4b 10%, transparent 10%) 3px -5px no-repeat,
                radial-gradient(circle, #eda65d 45%, transparent 45%) 0 -3px, linear-gradient(transparent 35%, #383c4b 35%,
...
<body>
    ...
    <div class="center-div">
        <a class="button-1" role="button" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Click to Feed the cat</a>
    </div>
